...
TOOL_DESCRIPTION = "Edit CItem_boss_neji.pkc via semantic JSON."
FORMAT_VERSION = "citem-boss-neji-semantic-json-1"
...
MODEL_BRRES_PC = 0x0904
SPAWN_OFFSET_SCALE_Y_PC = 0x091D
...
def export_semantic(document):
	...
	return {
		...
		"item_visuals": {
			...
			"spawn_offset_scale_y": read_push_float(pc_to_instruction, SPAWN_OFFSET_SCALE_Y_PC),
		},
		"messages": {
...
def apply_semantic(document, semantic):
	...
	write_push_float(pc_to_instruction, SPAWN_OFFSET_SCALE_Y_PC, semantic["item_visuals"]["spawn_offset_scale_y"])

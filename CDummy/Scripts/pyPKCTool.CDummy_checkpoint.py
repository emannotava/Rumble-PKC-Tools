...
FORMAT_VERSION = 'cdummy-checkpoint-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_checkpoint.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts',
 ...
 {'name': 'checkpoint_visuals',
  'kind': 'mixed_dict',
  'entries': [('show_flag', 'int', 2302), ('model_brres', 'string', 2308)]},
 {'name': 'checkpoint_trigger',
  'kind': 'mixed_dict',
  'entries': [('player_index', 'int', 2316),
              ('hp_zero_compare', 'int', 2339),
              ('collision_type', 'int', 2346),
              ('z_offset', 'float', 2378),
              ('sendto_message_id', 'int', 2388),
              ('sendto_target', 'int', 2389)]}]

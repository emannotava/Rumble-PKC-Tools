...
FORMAT_VERSION = 'cdummy-follower-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_follower.pkc via semantic JSON.'
SPECS = [{'name': 'math_helpers',
  'kind': 'mixed_dict',
  'entries': [('random_average_divisor', 'float', 58),
			  ('pow_exponent_a', 'float', 69),
			  ('pow_exponent_b', 'float', 76),
			  ('round_bias_subtract', 'float', 113),
			  ('round_bias_add', 'float', 117)]},
 {'name': 'pii_prop_lookup', 'kind': 'mixed_dict', 'entries': [('field_index', 'int', 181)]},
 {'name': 'lifecycle', 'kind': 'mixed_dict', 'entries': [('show_on_init', 'int', 187)]}]

...
FORMAT_VERSION = 'cdummy-tutorial-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_tutorial.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts', 'kind': 'string_list', 'pcs': [916, 922, 928, 934, 940, 946, 952, 958, 964, 970, 976, 982, 988, 994, 1000, 1006, 1034]}, {'name': 'money_item_script', 'kind': 'string', 'pc': 1887}, {'name': 'difficulty_rank_labels', 'kind': 'int_list', 'pcs': [2136, 2141, 2146, 2158, 2163, 2168, 2173, 2178]}, {'name': 'waza_desc_fields', 'kind': 'int_list', 'pcs': [2214, 2218, 2222, 2226, 2230]}, {'name': 'tutorial_layout', 'kind': 'mixed_dict', 'entries': [('archive', 'string', 2487), ('layout_name', 'string', 2488), ('initial_motion', 'string', 2492), ('secondary_motion', 'string', 2525), ('button_text_field_primary', 'string', 2551), ('button_text_field_secondary', 'string', 2587), ('variable_text_field', 'string', 2611), ('numeric_text_field', 'string', 2631), ('final_text_field', 'string', 2645), ('intro_off_motion', 'string', 2850), ('prompt_off_motion', 'string', 3016), ('confirm_off_motion', 'string', 3084), ('replace_off_motion', 'string', 3119), ('reward_off_motion', 'string', 3173), ('reward_confirm_off_motion', 'string', 3218), ('hp_off_motion', 'string', 3334), ('cleanup_off_motion', 'string', 3441), ('cleanup_fadein_motion', 'string', 3456), ('ending_off_motion', 'string', 3508)]}, {'name': 'tutorial_message_mids', 'kind': 'int_list', 'pcs': [2437, 2442, 2447, 2452, 2457, 2462, 2467, 2472, 2477, 2859, 2873, 3041, 3055]}, {'name': 'button_symbol_ids', 'kind': 'int_list', 'pcs': [2556, 2592, 3026, 3183]}]

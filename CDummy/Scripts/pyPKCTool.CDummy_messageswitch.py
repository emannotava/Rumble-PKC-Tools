...
FORMAT_VERSION = 'cdummy-messageswitch-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_messageswitch.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts',
 ...
 {'name': 'message_switch_behavior',
  'kind': 'mixed_dict',
  'entries': [('leave_init_state', 'int', 2299), ('show_on_init', 'int', 2304)]}]

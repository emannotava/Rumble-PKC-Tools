...
FORMAT_VERSION = 'cdummy-critical-motion-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_critical_motion.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts',
 ...
 {'name': 'critical_motion',
  'kind': 'int_dict',
  'pcs': {'enabled_flag': 2307,
          'set_register_object': 2312,
          'set_register_slot': 2313,
          'get_register_object_a': 2317,
          'get_register_slot_a': 2319,
          'get_register_object_b': 2323,
          'get_register_slot_b': 2325,
          'copy_dest_slot': 2327,
          'hitstop_frames': 2331}}]

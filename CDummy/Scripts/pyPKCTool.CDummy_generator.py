...
FORMAT_VERSION = 'cdummy-generator-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_generator.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts',
 ...
 {'name': 'difficulty_rank_labels', 'kind': 'int_list', 'pcs': [2136, 2141, 2146, 2158, 2163, 2168, 2173, 2178]},
 {'name': 'waza_desc_fields', 'kind': 'int_list', 'pcs': [2214, 2218, 2222, 2226, 2230]},
 {'name': 'generator_visuals',
  'kind': 'mixed_dict',
  'entries': [('show_before_load', 'int', 2299),
			  ('model_brres', 'string', 2308),
			  ('loop_motion', 'string', 2312),
			  ('show_after_load', 'int', 2316),
			  ('register_slot', 'int', 2320),
			  ('scale_duration_frames_start', 'float', 2335),
			  ('scale_duration_frames_loop', 'float', 2345),
			  ('dir_degrees', 'int', 2351),
			  ('dir_cycles', 'int', 2352)]}]

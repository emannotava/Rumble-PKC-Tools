...
FORMAT_VERSION = 'cdummy-wazamove-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_wazamove.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts', 'kind': 'string_list', 'pcs': [916, 922, 928, 934, 940, 946, 952, 958, 964, 970, 976, 982, 988, 994, 1000, 1006, 1034]}, {'name': 'money_item_script', 'kind': 'string', 'pc': 1887}, {'name': 'difficulty_rank_labels', 'kind': 'int_list', 'pcs': [2136, 2141, 2146, 2158, 2163, 2168, 2173, 2178]}, {'name': 'waza_desc_fields', 'kind': 'int_list', 'pcs': [2214, 2218, 2222, 2226, 2230]}, {'name': 'waza_behavior', 'kind': 'mixed_dict', 'entries': [('show_on_init', 'int', 2302), ('register_slot', 'int', 2308), ('power_field', 'int', 2315), ('spin_move_id_1', 'int', 2327), ('spin_move_id_2', 'int', 2331), ('spin_move_id_3', 'int', 2335), ('rotation_offset_deg', 'float', 2348), ('airborne_move_id', 'int', 2354), ('airborne_divisor', 'int', 2359), ('airborne_y_offset_abs', 'float', 2371), ('type_field_primary', 'int', 2384), ('type_id_primary', 'int', 2386), ('type_field_secondary', 'int', 2390), ('type_id_secondary', 'int', 2392), ('range_scale_factor', 'float', 2397), ('range_field', 'int', 2400), ('motion_field_primary', 'int', 2407), ('motion_field_secondary', 'int', 2429), ('sound_se', 'int', 2629), ('effect_id', 'int', 2633), ('effect_dir_deg', 'int', 2634), ('effect_scale_half', 'float', 2638)]}]

...
FORMAT_VERSION = 'cdummy-critical-se-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_critical_se.pkc via semantic JSON.'
SPECS = [{'name': 'embedded_event_scripts',
 ...
 {'name': 'critical_sound',
  'kind': 'int_dict',
  'pcs': {'camera_object_index': 2309,
          'camera_mode': 2311,
          'register_source_object': 2323,
          'start_se_arg': 2329,
          'se_id': 2332,
          'clear_register_object': 2336,
          'clear_register_slot': 2337,
          'stop_register_slot': 2343}}]

...
FORMAT_VERSION = 'cdummy-test-semantic-json-1'
TOOL_DESCRIPTION = 'Edit CDummy_test.pkc via semantic JSON.'
SPECS = [{'name': 'model_setup', 'kind': 'mixed_dict', 'entries': [('piiprop_field_index', 'int', 181), ('show_on_init', 'int', 187), ('model_brres', 'string', 193), ('rotation_cycle_deg', 'int', 201), ('rotation_step_multiplier', 'int', 211)]}]

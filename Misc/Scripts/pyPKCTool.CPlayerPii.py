...
TOOL_DESCRIPTION = 'Edit NCPP.pkc via semantic JSON.'
FORMAT_VERSION = 'ncpp-semantic-json-1'
...
STRING_FIELDS = {'embedded_scripts': {'wazamove_helper_script': 11972}}
INT_FIELDS = {'common_messages': {'dynamic_category_base_high': 1386, 'dynamic_category_base_low': 1397}, 'common_field_indexes': {'collection_type_field': 181, 'attack_field': 2795, 'boss_attack_multiplier_field': 2817, 'defense_field': 2907, 'boss_defense_multiplier_field': 2929, 'boss_speed_override_field': 2955, 'speed_field': 2965, 'boss_scalar_field': 3007, 'hp_field': 3164, 'boss_hp_multiplier_field': 3183, 'level_formula_hp_field': 3333}, 'wazamove_spawn': {'persistent_stat_id': 13350}}
INT_LIST_FIELDS = {'common_messages': {'difficulty_rank_labels': [2136, 2141, 2146, 2158, 2163, 2168, 2173, 2178]}, 'common_field_indexes': {'waza_desc_preview_fields': [2214, 2218, 2222, 2226, 2230], 'ppd_register_slots': [2315, 2334, 2364, 2383, 2413, 2432, 2462, 2481, 2500, 2519, 2540, 2561, 2582, 2603]}, 'wazamove_spawn': {'detail_waza_desc_fields': [4602, 4606, 4611, 4615], 'helper_eval_waza_desc_fields': [7329, 7337, 7359, 7365, 7380, 7383, 7387, 7391], 'new_obj_register_slots': [11513, 11517, 11522, 11526, 11539, 11543]}}
FLOAT_FIELDS = {'wazamove_spawn': {'angle_adjust_step_deg': 11469}}
FLOAT_LIST_FIELDS = {'wazamove_spawn': {'angle_table_degrees': [11487, 11491, 11495, 11499], 'new_obj_register_default_scales': [11518]}}

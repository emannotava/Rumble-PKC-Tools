...
FORMAT_VERSION = "debuggetallpii-semantic-json-1"
...
def apply_semantic(document, semantic):
	...
	if len(instructions) != 2:
		raise ValueError("DebugGetAllPii.pkc no longer matches the expected 2-instruction stub shape")
...
def build_arg_parser():
	parser = argparse.ArgumentParser(description="Edit DebugGetAllPii.pkc as a tiny stub script.")

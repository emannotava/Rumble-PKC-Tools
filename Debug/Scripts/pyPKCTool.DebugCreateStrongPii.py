...
FORMAT_VERSION = "debugcreatestrongpii-semantic-json-1"
...
def apply_semantic(document, semantic):
	...
	if len(instructions) != 2:
		raise ValueError("DebugCreateStrongPii.pkc no longer matches the expected 2-instruction stub shape")
...
def build_arg_parser():
	parser = argparse.ArgumentParser(description="Edit DebugCreateStrongPii.pkc as a tiny stub script.")
